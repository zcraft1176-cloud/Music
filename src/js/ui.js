            ...
            <div class="track-card flex items-center gap-4 p-3 rounded-lg cursor-pointer ${isPlaying ? 'playing' : ''}" data-track-index="${index}">
                ...
                <div class="flex items-center gap-2 shrink-0">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <button class="download-track-btn p-2 text-gray-400 hover:text-green-400 transition-colors" data-track-id="${track.id}" title="Download MP3">
    ...
    attachTrackListeners(container) {
        ...
        container.querySelectorAll('.download-track-btn').forEach((btn) => {
            btn.addEventListener('click', (e) => {
                ...
                const card = btn.closest('.track-card');
                const trackIndex = parseInt(card.dataset.trackIndex);
                if (tracks[trackIndex] && typeof Downloader !== 'undefined') {
